...
export default function EpsteinFilesCard({ variant = "full", className = "" }: EpsteinFilesCardProps) {
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-rose-600 flex items-center justify-center text-2xl mb-4 shadow-lg group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300">
            📁
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-rose-600 flex items-center justify-center text-3xl mb-6 shadow-lg group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300">
          📁
        </div>
