...
import MostCapturedPanel from "@/components/MostCapturedPanel";
import type { CapturedMember } from "@/components/MostCapturedPanel";
...
// Top 10 most-captured non-leadership members — sorted by PAC% desc
const TOP_CAPTURED: CapturedMember[] = (topCapturedData as CapturedMember[]).slice(0, 10);
