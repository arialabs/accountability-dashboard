  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,600;0,700;1,400&family=Newsreader:ital,wght@0,400;0,600;0,700;1,400;1,600&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@500;700&display=swap"
        />
        <script
      ...
      <body className="min-h-screen overflow-x-hidden">
        <PWARegister />
        <LayoutErrorBoundary>
          {/* Trust bar — single slim bar combining beta notice + data freshness */}
          <DevelopmentBanner />
